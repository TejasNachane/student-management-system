        ...
        try {
            ...
            if ($check_stmt->fetch()) {
                ...
                if ($insert_stmt->execute([$student_id, $username, $email, $hashed_password, $full_name, $phone, $address, $date_of_birth, $gender, $parent_name, $parent_phone])) {
                    ...
                    showNotification('Student added successfully. They will need to change their password on first login.', 'success');
            ...
            <form method="POST" class="validate-form" id="addStudentForm">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="student_id" name="student_id" class="form-control" 
                               value="<?php echo isset($_POST['student_id']) ? htmlspecialchars($_POST['student_id']) : generateStudentId(); ?>" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <small style="color: #666; font-size: 0.8rem;">Minimum 6 characters. Student will be required to change this on first login.</small>
                    </div>
                </div>
