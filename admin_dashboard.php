...
<head>
	...
	<style type="text/css">
		...
		.SearchStdBtn:hover,.AddStdBtn:hover,.delBtn:hover,.EditBtn:hover,.showBtn:hover{
...
<body>
	...
	<span id="top_span"><marquee>Note:- Please Fill The Information Carefulluy  </marquee></span>
	<div id="left_side">
		<br><br><br>
		<form action="" method="post">
			<table>
				<tr>
					<td>
						<input type="submit" name="search_student" value="Search Student" class="SearchStdBtn">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" name="edit_student" value="Edit Student" class="EditBtn">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" name="add_new_student" value="Add New Student" class="AddStdBtn">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" name="delete_student" value="Delete Student" class="delBtn">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" name="show teacher" value="Show Teachers" class="showBtn">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" name="show student" value="Show student" class="showBtn">
					</td>
				</tr>
			</table>
		</form>
