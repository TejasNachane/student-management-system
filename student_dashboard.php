	...
	<div id="left_side">
		...
		<form action="" method="post">
			...
			<table>
				<tr>
					<td>
						<input type="submit" name="edit_detail" value="Edit Detail" class="editbtn">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" name="show_detail" value="Show Detail" class="showbtn">
					</td>
				</tr>
			</table>
		</form>
